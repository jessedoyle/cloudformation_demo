...
yum install nodejs npm gnupg2 -y --enablerepo=epel >> /home/ec2-user/init.log 2>&1
yum groupinstall "Development Tools" -y >> /home/ec2-user/init.log 2>&1
gpg2 --keyserver hkp://keys.gnupg.net --recv-keys 409B6B1796C275462A1703113804BB82D39DC0E3 7D2BAF1CF37B13E2069D6956105BD0E739499BDB >> /home/ec2-user/init.log 2>&1
...
yum install -y git gcc72-c++ patch readline readline-devel zlib zlib-devel libyaml-devel libffi-devel openssl-devel make bzip2 autoconf automake libtool bison postgresql92 postgresql92-devel nginx aws-cfn-bootstrap >> /home/ec2-user/init.log 2>&1
...
cp /home/ec2-user/puma.conf /etc/init/puma.conf >> /home/ec2-user/init.log 2>&1
rm /home/ec2-user/.env.production /home/ec2-user/master.key /home/ec2-user/puma.conf >> /home/ec2-user/init.log 2>&1
...
chmod 644 /etc/init/puma.conf >> /home/ec2-user/init.log 2>&1
...
chmod +x /etc/init.d/nginx >> /home/ec2-user/init.log 2>&1
chkconfig nginx on >> /home/ec2-user/init.log 2>&1
